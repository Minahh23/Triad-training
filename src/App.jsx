...
function App() {
  ...
  const [masterPhone, setMasterPhone] = useState(import.meta.env.VITE_MASTER_PHONE);
      ...
      <div className="min-h-screen bg-[#050505] text-white pb-20 font-inter">
        <header className="p-6 border-b border-white/5 flex justify-between items-center bg-black/40 backdrop-blur-md sticky top-0 z-50">
          ...
          <div className="flex gap-2">
            <button onClick={() => setShowSettings(!showSettings)} className="p-3 bg-white/5 rounded-xl hover:bg-white/10 transition">⚙️</button>
            <button onClick={() => setView('auth')} className="p-3 bg-red-600/20 text-red-500 rounded-xl hover:bg-red-600/30 transition">🔒</button>
          </div>
        </header>
